...
var isPrivate = pathUtils.isPrivate
...
exports.onOverwriteNs = function (docs, countQuery, model) {
  if (typeof docs === 'undefined' && !isPrivate(countQuery.ns)) 
    return;		// Don't re-run store queries if we don't have the backing collection available.
...
exports.onAddDoc = function (newDoc, oldDoc, countQuery, model, searchSpace, currResult, alreadyPresent) {
